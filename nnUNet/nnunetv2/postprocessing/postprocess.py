...
if __name__=='__main__':
    foldername= f"/mmfs1/gscratch/kurtlab/brats2024/experiments/brats-goat/hitender/hitender-0719/inference"
    outfolder= f"/mmfs1/gscratch/kurtlab/brats2024/experiments/brats-goat/hitender/hitender-0719/inference_pp"
    if not os.path.exists(outfolder):
        os.makedirs(outfolder)

    #rm_dust_fh(foldername, outfolder)
    shutil.make_archive('nnUNetdisjointVal', 'zip', outfolder)
