...
testing_trained_models = tuple([
    {'plans': 'nnUNetPlans', 'configuration': '3d_fullres', 'trainer': 'nnUNetTrainer'},
    {'plans': 'nnUNetResEncUNetLPlans', 'configuration': '3d_fullres', 'trainer': 'nnUNetTrainer'},
])

if __name__ == '__main__':
    find_best_configuration(138,
                            testing_trained_models)
